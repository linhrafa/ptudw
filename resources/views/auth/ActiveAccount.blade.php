	...
	<div class="container">
        <div class="card card-container">
            ...
            <form id="auth_login" method="post" class="form-signin">
				...
				<p class="text-success">Đã kích hoạt tài khoản email <i class="semi-bold">{{$vnu_email}} thành công ! </i> !</p>
                <a href="/login"><button id="dauth_login" class="btn btn-lg btn-danger btn-block btn-signin" type="button">Đăng nhập ngay</button></a>
            </form><!-- /form -->
        </div><!-- /card-container -->
    </div><!-- /container -->
