      ...
      <div class="col-md-6 col-md-offset-3">
        <div class="grid simple">
          ...
          <div class="grid-body">
            ...
            <div id="new_teacher_form"><button id="start_new_teacher_form" type="button" class="btn btn-success">Thêm giảng viên</button> <button id="reset_form" type="button" class="btn btn-warning">Nhập lại</button></div>
          </div>
        </div>
      </div>
    </div>
